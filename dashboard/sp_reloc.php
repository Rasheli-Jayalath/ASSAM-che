...
{
mysql_query("Delete from t0211relocation where rcid=".$_REQUEST['rcid']);
}

//===============================================

 $pdSQL = "SELECT rcid, pgid, pid, serial, description, nolines, reloc, remarks FROM t0211relocation where pid = ".$pid." order by serial";
...
<div class="box-set">
  ...
  <tr style="height:10%">
    <td align="center" style="font-family:Verdana, Geneva, sans-serif; font-size:24px; font-weight:bold;"><span>Relocation of Utilities</span><span style="float:right">
...
{
?>
  <span style="text-align:right; "><form action="sp_reloc_input.php" method="post"><input type="submit" name="add_new " id="add_new" value="Add New Record" /></form></span>
  <?php
  }
  ?>
  ...
  <table width="100%" class="table table-bordered">
                              <thead>
                                <tr>
                                  ...
                                  <th width="25%" style="text-align:center">Type of Utility</th>
                                  <th width="5%" style="text-align:center">Number of Lines</th>
								  <th width="35%" style="text-align:center">Relocation/ Upraising Status</th>
                        ...
                        <tr>
                          ...
                          <td align="center"><?php echo $pdData['nolines'];?></td>
                          <td align="left"><?php echo $pdData['reloc'];?></td>
                          <td align="left"><?php echo $pdData['remarks'];?></td>
                          <?php if($adminflag==1)
								  {
								   ?>
						  <td align="right"><span style="float:left"><form action="sp_reloc_input.php?rcid=<?php echo $pdData['rcid'] ?>" method="post"><input type="submit" name="edit" id="edit" value="Edit" /></form></span><span style="float:right"><form action="sp_reloc.php?rcid=<?php echo $pdData['rcid'] ?>" method="post"><input type="submit" name="delete" id="delete" value="Del" onclick="return confirm('Are you sure?')" /></form></span></td>
						  <?php
						  }
						  ?>
                        </tr>
