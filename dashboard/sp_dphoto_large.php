...
<div class="box-set">
  ...
  <tr style="height:10%">
    <td align="center" style="font-family:Verdana, Geneva, sans-serif; font-size:24px; font-weight:bold;"><span><?php  
			...
			$pdSQL = "SELECT phid, pid, al_file, ph_cap FROM t027project_dphotos WHERE phid = ".$phid." order by phid";
			 $pdSQLResult = mysql_query($pdSQL);
			$result = mysql_fetch_array($pdSQLResult);
			echo $result["ph_cap"];?>
                </span><span style="float:right"><form action="sp_dphoto.php" method="post"><input type="submit" name="back" id="back" value="BACK" /></form></span></td></tr>
