...
{
mysql_query("Delete from t024project_progress_table where ppt_id=".$_REQUEST['ppt_id']);
}

//===============================================

 $pdSQL = "SELECT ppt_id,pid, act_id,ppt_planned as planned_percent,ppt_actual as actual_percent FROM t024project_progress_table where  pid=$pid  order by ppt_id";
...
<div class="box-set">
  ...
  <tr style="height:10%"><td align="center" style="font-family:Verdana, Geneva, sans-serif; font-size:24px; font-weight:bold;"><span>Components Progress</span><span style="float:right"><form action="chart1.php" method="post"><input type="submit" name="back" id="back" value="BACK" /></form></span></td></tr>
 
  <tr style="height:100%"><td align="center">
  <?php /*if($adminflag==1)
								  {
								   ?>
  <span style="text-align:right; "><form action="sp_major_items_input.php" method="post"><input type="submit" name="add_new " id="add_new" value="Add New Record" /></form></span>
  <?php
  }*/
  ?>
  ...
  <table width="100%" class="table table-bordered">
                              <thead>
                                <tr>
                                  ...
                                  <th width="65%" style="text-align:center">Activity Name</th>
