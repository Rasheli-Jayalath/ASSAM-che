...
if(isset($_REQUEST['save']))
{
	...
	$message="";
	$pgid=1;
$sql_pro=mysql_query("INSERT INTO t0171interchanges (pid, serial, description, total, inprogress, completed) Values(".$pid.",".$serial.", '".$description."',".$total.",".$inprogress.", ".$completed.")");
	if ($sql_pro == TRUE) {
