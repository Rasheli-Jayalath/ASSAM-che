...
<?php } ?><?php */?>
<title>
Second Irrigation and Drainage Improvement Project (IDIP-2)</title>
...
<div class="box-set">
  ...
  <table  style="border:1px; width:100%; height:100%; padding:10px;">
                      ...
                      <tbody>
                        <tr>
                          <td width="155"><strong>Components:</strong></td>
                          <td width="112" align="left"><?php 
						  if($plength!=""&&$plength!=NULL)
						  echo $plength ?></td>
                        </tr>
                        <tr>
                          <td><strong>Contractors:</strong></td>
                          <td align="left"><?php echo $pcon; ?></td>
                        </tr>
                        <tr>
                          <td><strong>Consultant (M&amp;E):</strong></td>
                          <td align="left"><?php echo $pcons; ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td align="left"> <?php if(isset($pend)&&$pend!=""&&$pend!=NULL&&$pend!="1970-01-01"){echo date("d/m/Y", strtotime($pend));} ?></td>
                        </tr>
                        <tr>
                          <td><strong>Source of Funds:</strong></td>
                          <td align="left"><?php echo $psrc; ?></td>
                        </tr>
...
?>  
  ...
  <table  style="border:thick #000; width:100%; height:100%; padding:10px;">
                      <thead><th colspan="3"><h3>Progress of Components  as of 
...
<table  style="border:thick #000; width:100%; height:100%; padding:0px;">
                      ...
                      <tbody>
                        <tr style="padding:0px; margin:0px;"><td width="50%" style="padding:0px; margin:0px;"><form action="sp_pc1.php"><input type="submit" value="PC-1 Summary" style="width:100%; height:40px; margin:0px; padding:0px; font-family:Verdana, Geneva, sans-serif; font-size:10px;font-weight:bold;"></form></td><td width="50%" style="padding:0px; margin:0px;"><form action="sp_plphoto.php"><input type="submit" value="Project Layout Plan" style="width:100%; height:40px; margin:0px; padding:0px; font-family:Verdana, Geneva, sans-serif; font-size:10px;font-weight:bold;"></form></td></tr>


                        <tr style="padding:0px; margin:0px;"><td  style="width:50%;padding:0px; margin:0px;"><span style="width:50%; height:100%; padding:0px; margin:0px;"><form action="sp_dphoto.php"><input type="submit" value="Drawings" style="width:100%; height:40px; margin:0px; padding:0px; font-family:Verdana, Geneva, sans-serif; font-size:10px;font-weight:bold;"></form></span></td><td width="50%" style="padding:0px; margin:0px;"><form action="sp_photo.php"><input type="submit" value="Progress Photographs" style="width:100%; height:40px; margin:0px; padding:0px; font-family:Verdana, Geneva, sans-serif; font-size:10px;font-weight:bold;"></form></td></tr>

                       
                        <tr style="padding:0px; margin:0px;"><td  style="width:50%;padding:0px; margin:0px;"><span style="width:50%; height:100%; padding:0px; margin:0px;"><form action="sp_component_wise.php"><input type="submit" value="Component Wise KPIs" style="width:100%; height:40px; margin:0px; padding:0px; font-family:Verdana, Geneva, sans-serif; font-size:10px;font-weight:bold;"></form></span></td><td width="50%" style="padding:0px; margin:0px;"><form action="sp_video.php"><input type="submit" value="Videos" style="width:100%; height:40px; margin:0px; padding:0px; font-family:Verdana, Geneva, sans-serif; font-size:10px;font-weight:bold;"></form></td></tr>

                        <tr style="padding:0px; margin:0px;"><td width="50%" style="padding:0px; margin:0px;"><form action="sp_deva.php"><input type="submit" value="Earned Value Analysis" style="width:100%; height:40px; margin:0px; padding:0px; font-family:Verdana, Geneva, sans-serif; font-size:10px;font-weight:bold;"></form></td><td width="50%" style="padding:0px; margin:0px;"><form action="sp_qaqc.php"><input type="submit" value="QA/QC Tests" style="width:100%; height:40px; margin:0px; padding:0px; font-family:Verdana, Geneva, sans-serif; font-size:10px;font-weight:bold;"></form></td></tr>
                        ...
                        <tr><td  style="width:50%;"><span style="width:50%; height:100%; padding:0px; margin:0px;"><form action="sp_maindashboard.php"><input type="submit" value="Projects List" style="width:100%; height:40px; margin:0px; padding:0px; font-family:Verdana, Geneva, sans-serif; font-size:10px;font-weight:bold;"></form></span></td>
                          <td style="width:50%"> <span style="width:50%; height:100%; padding:0px; margin:0px;"><a href="http://www.egcpakistan.com/index.php?id=it" target="_blank"><img src="sj.png"  width="200px" style="padding:0px;" /></a></span> </td>
                        </tr>
                      </tbody>
    </table> 
  </figure>
...
<table  style="border:thick #000; width:100%; height:100%; padding:10px;">
                      <thead><th colspan="2"><h3>Major Issues and Recommendation <?php if($adminflag==1)
								  {
...
?>  
<table  style="border:thick #000; width:100%; padding:10px;">
                      <thead><th colspan="3"><h3>Project Expected Completion Dates 
					  <?php if($adminflag==1)
								  {
