...
if(isset($_REQUEST['save']))
{
	...
	$message="";
	$pgid=1;
$sql_pro=mysql_query("INSERT INTO t024project_progress_table (pid, act_id, ppt_planned, ppt_actual) Values(".$pid.",'".$act_id."',".$ppt_planned.",".$ppt_actual.")");
	if ($sql_pro == TRUE) {
...
<div class="box-set">
  ...
  <tr style="height:10%"><td align="center" style="font-family:Verdana, Geneva, sans-serif; font-size:24px; font-weight:bold;"><span>Component Progress</span><span style="float:right"><form action="sp_major_items.php" method="post"><input type="submit" name="back" id="back" value="BACK" /></form></span></td></tr>
