...
{
mysql_query("Delete from t023project_progress_graph where ppg_id=".$_REQUEST['ppg_id']);
}

//===============================================

$pdSQL = "SELECT ppg_id, pid, planned, actual, ppg_date from t023project_progress_graph where pid = ".$pid;
...
<div class="box-set">
  ...
  <tr style="height:10%"><td align="center" style="font-family:Verdana, Geneva, sans-serif; font-size:24px; font-weight:bold;"><span>Project Progress </span><span style="float:right"><form action="chart1.php" method="post"><input type="submit" name="back" id="back" value="BACK" /></form></span></td></tr>
 
  <tr style="height:100%"><td align="center">
  <?php if($adminflag==1)
								  {
								   ?>
  <span style="text-align:right; "><form action="sp_progress_graph_input.php" method="post"><input type="submit" name="add_new " id="add_new" value="Add New Record" /></form></span>
  <?php
  }
  ?>
 <div style="overflow-y: scroll; height:400px;">
  <table width="100%" class="table table-bordered">
                              <thead>
                                <tr>
								 <th width="5%" style="text-align:center; vertical-align:middle">#</th>
                                  <th width="25%" style="text-align:center; vertical-align:middle">Month</th>
                                  <th width="30%" style="text-align:center">Planned (%)</th>
                                  <th width="30%" style="text-align:center">Actual (%)</th>
						...
						<td align="center"><?php echo $i;?></td>
                          ...
                          <td align="left"><?php echo $pdData['planned']; ?></td>
                          <td align="left"><?php echo $pdData['actual']; ?></td>
                          
						  <?php if($adminflag==1)
								  {
								   ?>
						   <td align="right"><span style="float:left"><form action="sp_progress_graph_input.php?ppg_id=<?php echo $pdData['ppg_id'] ?>" method="post"><input type="submit" name="edit" id="edit" value="Edit" /></form></span><span style="float:right"><form action="sp_progress_graph.php?ppg_id=<?php echo $pdData['ppg_id'] ?>" method="post"><input type="submit" name="delete" id="delete" value="Del" onclick="return confirm('Are you sure?')" /></form></span></td>
						   <?php
						   }
						   ?>
                        </tr>
