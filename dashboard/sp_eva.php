...
<div class="box-set">
  ...
  <tr style="height:10%">
    <td align="center" style="font-family:Verdana, Geneva, sans-serif; font-size:24px; font-weight:bold;"><span>Earned Value Analysis (Tabular Data)</span><span style="float:right">
    <form action="sp_deva.php" method="post"><input type="submit" name="back" id="back" value="BACK" /></form></span></td></tr>
 
  <tr style="height:100%"><td align="center">
 <?php if($adminflag==1)
{
?>
  <span style="text-align:right; "><form action="sp_eva_input.php" method="post"><input type="submit" name="add_new " id="add_new" value="Add New Record" /></form></span>
  ...
  <table width="100%" class="table table-bordered">
                              <thead>
                                <tr>
                                  ...
                                  <th width="25%" style="text-align:center">Indicator</th>
                                  <th width="5%" style="text-align:center">value (<?php echo $proj_cur;?>)</th>
								  <?php if($adminflag==1)
								  {
								   ?>
                        ...
                        <tr>
                          ...
                          <?php if($adminflag==1)
								  {
								   ?>
						  <td align="right"><span style="float:left"><form action="sp_eva_input.php?rcid=<?php echo $pdData['rcid'] ?>" method="post"><input type="submit" name="edit" id="edit" value="Edit" /></form></span><span style="float:right"><form action="sp_eva.php?rcid=<?php echo $pdData['rcid'] ?>" method="post"><input type="submit" name="delete" id="delete" value="Del" onclick="return confirm('Are you sure?')" /></form></span></td>
						  <?php
						  }
						  ?>
                        </tr>
