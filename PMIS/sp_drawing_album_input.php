...
<table  align="center">
  ...
  <form name="form2" action="sp_drawing_album_input.php?album_id=<?php echo $album_id; ?>" target="_self" method="post"  enctype="multipart/form-data" onSubmit="return required()">
  ...
  <tr><td><label><?php echo "Drawing Type:";?></label></td>
  <td ><select  name="dwg_type" id="dwg_type"  >
  ...
  <td><input  type="file" name="al_file" id="al_file"  />
  ...
  <tr><td colspan="2" align="center"> <?php if(isset($_REQUEST['dwgid']))
	 ...
	 ?> <input  type="button" name="cancel" id="cancel" value="Cancel"   onclick="cancelButton();"/></td></tr>
	 </table>
