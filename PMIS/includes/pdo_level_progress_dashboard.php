...
$(function () {
            ...
            series: [
		{
                ...
                data: [
				<?php echo GetActualQtysOutputLevel($aparentgroup,$temp_id);?>
			...
			,{
				...
				<?php echo GetPlannedQtysOutputLevel($aparentgroup,$temp_id);?>
...
<?php if($parentgroup!=0&&$parentgroup!="")
		{
		$reportquery_act ="SELECT * from maindata where parentcd=".$parentcd;
		$reportresult_act = mysql_query($reportquery_act);
		$check=mysql_num_rows($reportresult_act);
		if($check==0)
		{
...
<td style="text-align:right;"><?php if($projected_daten!=""&&$projected_daten!="1970-01-01"&&$projected_daten!="0000-00-00")
									echo date('d-m-Y',strtotime($projected_daten));?></td>
