...
$ipcnodata=LastIPcNO();?>
<div id="result4">
<table id="tblList" cellpadding="0px" cellspacing="0px"    align="left" >
<tr  id="title">
...
function getContractAmount($itemid)
{
	$sum=0;
	$i=1;
	$amount=0;
 if($itemid!=0&&$itemid!=0&&$itemid!='')
 {
	 ...
	 while($data=mysql_fetch_array($pamountresult))
	 {
	  ...
	  $amount +=$data["boqqty"]*$data["boqrate"];
...
$i=1;
/*echo $reportquery="SELECT a.itemid, a.parentcd ,a.parentgroup ,a.activitylevel ,a.stage ,a.factor ,a.itemcode ,a.itemname ,a.weight, b.boqid , b.boqcode , b.boqitem , b.boqunit , b.boqrate , b.boqqty ,sum(b.boqqty* b.boqrate) as total_amount, b.boqamount , b.boqcurrency , b.boqcurrrate , b.boqfamount , b.boqfcurrency , b.boqfrate , b.boqfcurrate FROM boqdata a LEFT OUTER JOIN boq b ON (a.itemid = b.itemid) where a.parentcd=$itemid group by b.itemid";*/
if($actlevel==0)
{
$reportquery="SELECT a.itemid, a.parentcd ,a.parentgroup ,a.activitylevel ,a.stage ,a.isentry, a.factor ,a.itemcode ,a.itemname ,a.weight, b.boqid , b.boqcode , b.boqitem , b.boqunit , b.boqrate , b.boqqty , b.boqamount , b.boqcurrency , b.boqcurrrate , b.boqfamount , b.boqfcurrency , b.boqfrate , b.boqfcurrate FROM boqdata a LEFT OUTER JOIN boq b ON (a.itemid = b.itemid) where a.parentcd=$itemid ";
}
else
{
 
$reportquery="SELECT b.itemid, a.parentcd ,a.parentgroup ,a.activitylevel , a.isentry, a.stage ,a.factor ,a.itemcode ,a.itemname ,a.weight, b.boqid , b.boqcode , b.boqitem , b.boqunit , b.boqrate , b.boqqty ,sum(b.boqqty* b.boqrate) as total_amount, b.boqamount , b.boqcurrency , b.boqcurrrate , b.boqfamount , b.boqfcurrency , b.boqfrate , b.boqfcurrate FROM boqdata a INNER JOIN boq b ON (a.itemid = b.itemid) where a.parentcd=$itemid group by b.itemid ";
}
...
$this_amount=0;
$uptolast_amount=0;
$reportquery_sub="SELECT a.itemid, a.parentcd ,a.parentgroup ,a.activitylevel ,a.stage ,a.factor , a.isentry, b.boqid,b.boqcode,b.boqitem , b.boqunit , b.boqrate , b.boqqty , b.boqamount , b.boqcurrency ,b.boqcurrrate , b.boqfamount, b.boqfcurrency , b.boqfrate , b.boqfcurrate FROM boqdata a LEFT OUTER JOIN boq b ON (a.itemid = b.itemid) where a.parentcd=".$reportdata_act['itemid'];
...
{
$contract_amount=getContractAmount($reportdata_act['itemid']);
