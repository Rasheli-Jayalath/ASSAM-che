...
$pdSQL = "SELECT * FROM  locations WHERE pid=".$pid." order by lid";
   ...
   {
	   ?>
       <a class="SubmitButton"  href="javascript:void(null);" onclick="window.open('pictorial_form.php', '<?php echo PLOAD_PHOTO_BTN;?> ','width=730px,height=550px,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=0,left=0,top=0');"  style="margin:5px; text-decoration:none"><?php echo PLOAD_PHOTO_BTN;?></a>
...
<form name="forma" id="forma" action=""  method="post"  enctype="multipart/form-data" onsubmit="return doFilter3();" >
  ...
  <tr>
  <td colspan="2"><select id="location" name="location" onchange="getCanals(this.value)" style="width:242px">
  ...
  <tr>
  <td colspan="2">
  <div id="canal_div" style="width:100%">
  <select id="canal_name" name="canal_name" onchange="getDates(this.value,<?php echo  $_REQUEST['location']; ?>)" style="width:242px">
  ...
  <select id="date_p" name="date_p" style="width:120px">
     <option value="0"><?php echo DATE;?> </option>
     <?php 
	if(isset($_REQUEST['canal_name']) && isset($_REQUEST['location']))
	 {
		$canal= $_REQUEST['canal_name'];
  ...
  <tr><td colspan="2" align="center"> 
	<input type="submit"    class="SubmitButton" name="Submit" id="Submit" value=" <?php echo VIEW; ?> " />
	</td></tr>
	 </table>
...
<div style="vertical-align:top; margin:5px 0px 0px 5px; padding:5px 0px 0px 5px;" id="Gallery_View">
   <?php if(!empty($_REQUEST['date_p'])&&!empty($_REQUEST['location'])&&!empty($_REQUEST['canal_name'])&&!empty($_REQUEST['date_p2']))
  {
