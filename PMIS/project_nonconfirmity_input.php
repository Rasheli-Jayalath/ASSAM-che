...
if(isset($_REQUEST['update']))
{
	...
	{
$sql_pro="UPDATE t013nonconformitynotice SET iss_no='$iss_no', iss_title='$iss_title', iss_detail='$iss_detail',  iss_status='$iss_status',  iss_action='$iss_action', iss_remarks='$iss_remarks' , comp_id='$comp_id'  where nos_id=$nos_id";
	}
...
<div id="content">
  ...
  <?php echo $message; ?>
  <form action="project_nonconfirmity_input.php" target="_self" method="post"  enctype="multipart/form-data" onsubmit="return required();">
  <table class="issues" width="100%" style="background-color:#FFF">
