...
<table border="1px solid" width="100%" >
		...
		{
		  $abc= $_GET["user_cd"];
		$cdsql2 = "select albumid,parent_id,album_name,user_ids,user_right from $pmis_db.t031project_drawingalbums where albumid = ".$cdlist[$items-1];
		...
		$cdsqlt = "select albumid,album_name,user_ids,user_right from $pmis_db.t031project_drawingalbums where albumid = ".$parent_cdd;
  ...
  <input type="radio" name="statusd<?php echo $category_cd2;?>" value="2" <?php if($s_value=="2"){ echo "checked";} ?>  onclick="Showactived(<?php echo $category_cd2;?>,2,<?php echo $items; ?>,<?php echo $abc; ?>)"  >R
  <input type="radio" name="statusd<?php echo $category_cd2;?>" value="1" <?php if($s_value=="1"){ echo "checked";} ?> onclick="Showactived(<?php echo $category_cd2;?>,1,<?php echo $items; ?>,<?php echo $abc; ?>)">R/W
  <input type="radio" name="statusd<?php echo $category_cd2;?>" value="3" <?php if($s_value=="3"){ echo "checked";} ?> onclick="Showactived(<?php echo $category_cd2;?>,3,<?php echo $items; ?>,<?php echo $abc; ?>)">R/W/D
  <input type="radio" name="statusd<?php echo $category_cd2;?>" value="0"  <?php if($s_value=="0"){ echo "checked";} ?> onclick="Showactived(<?php echo $category_cd2;?>,0,<?php echo $items; ?>,<?php echo $abc; ?>)"> No
  </div>
